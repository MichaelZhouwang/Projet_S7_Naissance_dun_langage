...
public class Controleur implements Initializable {	
	...
	public void remplirTexteEvenements() {
		...
		for (OccurrenceLemme occurrence : donneesTexteEvenements) {
			...
			String stringEvenement = " ("
				...
				+ occurrence.lireLemme() + " à la date "
	...
	public void remplirTableLexique() {
		...
		tableLexique.setPlaceholder(new Text("Cliquez sur une barre du graphe pour obtenir les détails associés"));
	...
	public void creerDiagrammeEvolutionLexique() {
		...
		diagrammeEvolutionLexique.setTitle("Évolution des lexiques (origine)");
	...
	public void creerDiagrammeEvolutionOccurrences() {
		...
		diagrammeEvolutionOccurrences.setTitle("Évolution des occurrences (" + typeEvenementOccurrences + ")");
	...
	public void remplirTableOccurrences() {
		...
		tableOccurrences.setPlaceholder(new Text("Cliquez sur une barre du graphe pour obtenir les détails associés"));
